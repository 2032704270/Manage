  ...
  <div>
    <el-card class="box-card">
      ...
      <el-table :data="list" stripe style="width: 100%" >
        <el-table-column prop="province_id" label="编号" width="120"></el-table-column>
        <el-table-column label="省名">
          <template slot-scope="scope">
            <div>
              <span>{{ scope.row.province_name }}</span>
              <i class="el-icon-edit-outline" @click="updatepName(scope.row.province_name, scope.row.province_id)"></i>
            </div>
          </template>
        </el-table-column>
        <el-table-column label="收录城市">
          <template slot-scope="scope">
            <div>
        ...
        <el-table-column label="更多操作">
          <template slot-scope="scope">
            <el-row>
              ...
              <el-button @click="deleteUser(scope.row.province_id)" type="danger" icon="el-icon-delete">删除</el-button>
            </el-row>
          </template>
        </el-table-column>
      </el-table>
